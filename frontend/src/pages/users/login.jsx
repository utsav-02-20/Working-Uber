      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <div className="rounded-[28px] border border-black/[0.08] bg-white p-7 shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
          ...
          <p className="mt-2 text-[13px] opacity-60">
            Login to book clean rides in Bhagalpur.
          </p>
          ...
          <div className="mt-8 space-y-3">
            ...
            <div className="flex gap-3 rounded-2xl bg-[#faf8f5] border border-black/5 p-4">
              ...
              <div className="flex-1">
                ...
                <input
                  ...
                  className={`w-full bg-transparent outline-none text-[14px] font-medium mt-1 placeholder:opacity-30 border-b pb-2 transition-colors ${
                    emailError
                      ? "border-red-500"
            ...
            <div className="flex gap-3 rounded-2xl bg-[#faf8f5] border border-black/5 p-4">
              ...
              <Eye size={16} className="opacity-30 cursor-pointer" />
            </div>
          </div>
          ...
          <div className="mt-6 flex justify-between text-[12px]">
            ...
            <Link to="/usersignup" className="font-medium underline">
              Create account
            </Link>
          </div>

          <p className="mt-6 text-center text-[11px] opacity-40">
            Clean cars • No OTP spam • Bihar only
          </p>
        </div>
      </div>
    </div>
